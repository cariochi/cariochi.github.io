...
* **2.0.x** — Java 17+ and Spring 6.x (Spring Boot 3.x)
* **2.1.x** — Java 17+ and Spring 7.x (Spring Boot 4.x); see the [current documentation]({{ '/recordo' | relative_url }})
